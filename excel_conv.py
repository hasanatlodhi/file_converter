...
# Load the Excel file
    ...
    workbook.save(outputFile, pdf_save_options)
    
    remove_text_from_pdf(outputFile,outputFile,'Evaluation Only. Created with Aspose.Cells for .NET.Copyright 2003 - 2023 Aspose Pty Ltd.')
