...
def generate_pdf_from_excel(input_path):
# Load the Excel file
    ...
    workbook.save(output_pdf_path, pdf_save_options)
    
    outputFile = r"Ooutput.pdf"
    remove_text_from_pdf(output_pdf_path,outputFile,'Evaluation Only. Created with Aspose.Cells for .NET.Copyright 2003 - 2023 Aspose Pty Ltd.')

# generate_pdf_from_excel('scccs.xlsx')
